...
namespace CardInfrastructure.Migrations
{
    ...
    [Migration("20250623180211_AddDataAnnotations")]
            ...
            modelBuilder.Entity("CardLibrary.Models.CardBase", b =>
                {
                    ...
                    b.HasIndex("GradingId")
                        .IsUnique()
                        .HasFilter("[GradingId] IS NOT NULL");
            ...
            modelBuilder.Entity("CardLibrary.Models.CardBase", b =>
                {
                    ...
                    b.HasOne("CardLibrary.Models.CardGrading", "Grading")
                        .WithOne("Card")
                        .HasForeignKey("CardLibrary.Models.CardBase", "GradingId");
